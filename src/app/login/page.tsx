...
function LoginForm() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden">
      ...
      <Card className="w-full max-w-md overflow-hidden border-white/20 shadow-2xl shadow-indigo-500/10">
        <div className="relative bg-gradient-to-br from-indigo-600 via-violet-600 to-purple-700 p-8 text-center text-white">
        ...
        <CardContent className="p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {error && (
              <div className="flex items-center gap-2 rounded-lg border border-red-200 bg-red-50 p-3 text-sm" style={{ color: "#bd1727" }}>
          ...
          <div className="mt-5 rounded-lg border border-dashed border-indigo-200 bg-indigo-50/50 p-3 text-center text-xs text-muted-foreground dark:border-indigo-900/50 dark:bg-indigo-950/30">
      ...
      <footer className="relative z-10 mt-auto border-t border-white/10 px-4 py-2 backdrop-blur-md dark:border-white/5" style={{ backgroundColor: "#f5eeed", color: "#48069e" }}>
        <div className="mx-auto flex max-w-5xl flex-col items-center justify-between gap-3 sm:flex-row">
          ...
          <nav className="flex items-center gap-1 text-xs">
            <Link
              href="/privacy"
              className="rounded-md px-2 py-1 transition-colors hover:bg-indigo-500/10"
            >
              Privacy
            </Link>
            <span>·</span>
